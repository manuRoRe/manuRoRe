...
<strong> - Frontend</strong>: React (Zustand, TanStack Query), Angular, Laravel.[![My Skills](https://skillicons.dev/icons?i=react,angular,laravel)](https://skillicons.dev)
</br><strong> - Backend</strong>: Node.js, Laravel, Spring Boot.
</br><strong> - Herramientas</strong>: Docker, Git, Figma.
